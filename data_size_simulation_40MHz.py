...
def main():
    bandwidths = [40]  # 40 MHz
    tones_dict = {
        40: [26, 52, 106, 242, 484]  # 20 MHz에서의 톤
    }
    packet_sizes = [500, 1000, 1500]  # 패킷 크기

    current_dir = os.path.dirname(os.path.abspath(__file__))
    output_file_csv = os.path.join(current_dir, "simulation_results_40MHz.csv")
    output_file_npy = os.path.join(current_dir, "data_size_simulation_40MHz.npy")
    output_dir = os.path.join(current_dir, "plots_40MHz")
